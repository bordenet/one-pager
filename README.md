...
1. **Open the application** - Visit the [live demo](https://bordenet.github.io/one-pager/) or run locally
2. **Create a new project** - Click "New Project" and fill in topic, audience, and key points
...
6. **Export** - Download your completed one-pager as Markdown
