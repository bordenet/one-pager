...
print_header "One-Pager - macOS Setup"
...
PACKAGE_HASH=$(shasum -a 256 package.json | awk '{print $1}' | cut -c1-8)
...
echo ""
echo "Next steps:"
echo "  open index.html     # Open the one-pager application"
