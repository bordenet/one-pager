 ...
 * Handles importing existing One-Pagers from Word/Google Docs via paste
 */
...
const DOC_TYPE = 'One-Pager';
const DOC_TYPE_SHORT = 'One-Pager';
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] flex flex-col">
        <div class="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
          <h2 class="text-xl font-semibold text-gray-900 dark:text-white">
            📋 Import Existing ${DOC_TYPE_SHORT}
          </h2>
        ...
        <div class="p-4 overflow-y-auto flex-1">
          <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
            Paste your ${DOC_TYPE_SHORT} from Word, Google Docs, or any source below. We'll convert it to Markdown automatically.
          </p>
...
export function showImportModal() {
  ...
  copyPromptBtn.addEventListener('click', () => {
    navigator.clipboard.writeText(LLM_CLEANUP_PROMPT + previewArea.value).then(() => {
